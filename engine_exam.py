...
while start == "Y":
    ...
    if start.lower().strip() == "instructions" or start.lower().strip() == "i":
        ...
        "If you have any issues, email me at xxxxxxxxxxxxxxx or put an issue in my GitHub at Reader-07 and I will respond eventually.\n")
        start = "Y"
...
while again == "Y" or "y":
    if state == "d":
        print("\033c")
    print(f"You have completed {questions} questions this session. \n")
...
# Questions 1 through 14, any driopped component that hits the floor, tool pan, or tray will be considered a dropped penalty.
    if rand_int == 1:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "push rod":
            print("\nCorrect!"); correct += 1; questions += 1
        else:
            print("\nSorry! The correct answer was Push Rod."); wrong += 1; questions += 1
    elif rand_int == 2:
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "air cleaner":
            ...
            print("\nSorry! The correct answer was Air Cleaner."); wrong += 1; questions += 1
    elif rand_int == 3:
        ...
        if ans.lower().strip() == "timing chain and/or timing gear" or ans.lower().strip() == "a":
            ...
            print("\nSorry! The correct answer was Timing Chain and/or Timing Gear."); wrong += 1; questions += 1
    elif rand_int == 4:
        ...
        if ans.lower().strip() == "distributor" or ans.lower().strip() == "c":
            ...
            print("\nSorry! The correct answer was Distributor."); wrong += 1; questions += 1
    elif rand_int == 5:
        ...
        if ans.lower().strip() == "cylinder head" or ans.lower().strip() == "a":
            ...
            print("\nSorry! The correct answer was Cylinder Head."); wrong += 1; questions += 1
    elif rand_int == 6:
        print("Which dropped component will be a 5 minute penalty?\n a) Rocker Arm\n b) Oil Pan\n c) Rod Bearing Half\n d) Intake Manifold\n")
        ans = input("What is your answer? ")
        if ans.lower().strip() == "intake manifold" or ans.lower().strip() == "d":
            ...
            print("\nSorry! The correct answer was Intake Manifold."); wrong += 1; questions += 1
    elif rand_int == 7:
        print("Which dropped component will be a 5 minute penalty?\n a) Oil Pan\n b) Cylinder Head\n c) Air Cleaner\n d) Exhaust Header\n")
        ans = input("What is your answer? ")
        if ans.lower().strip() == "exhaust header" or ans.lower().strip() == "d":
            ...
            print("\nSorry! The correct answer was Exhaust Header."); wrong += 1; questions += 1
    elif rand_int == 8:
        ...
        if ans.lower().strip() == "cylinder head gasket" or ans.lower().strip() == "c":
            ...
            print("\nSorry! The correct answer was Cylinder Head Gasket."); wrong += 1; questions += 1
    elif rand_int == 9:
        print("Which dropped component will be a 15 second penalty?\n a) Camshaft Bolts\n b) Lifter Bars\n c) Spark Plug\n d) Oil Filter\n")
        ans = input("What is your answer? ")
        if ans.lower().strip() == "d" or ans.lower().strip() == "oil filter":
            ...
            print("\nSorry! The correct answer was Oil Filter."); wrong += 1; questions += 1
    elif rand_int == 10:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "15 seconds":
            ...
            print("\nSorry! The correct answer was 15 seconds."); wrong += 1; questions += 1
    elif rand_int == 11:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "2 minutes":
            ...
            print("\nSorry! The correct answer was 2 minutes."); wrong += 1; questions += 1
    elif rand_int == 12:
        ...
        if ans.lower().strip() == "d" or ans.lower().strip() == "5 minutes":
            ...
            print("\nSorry! The correct answer was 5 minutes."); wrong += 1; questions += 1
    elif rand_int == 13:
...
# Questions 15 through 66 are either True or False.
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "true":
            ...
            print("\nSorry! The correct answer was True."); wrong += 1; questions += 1
    elif rand_int == 16:
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "false":
            ...
            print("\nSorry! The correct answer was False."); wrong += 1; questions += 1
    elif rand_int == 17:
...
# Questions 67 through 77 will be automotive acronyms.
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "anti-lock brake system":
            ...
            print("\nSorry! The correct answer was Anti-lock Brake System."); wrong += 1; questions += 1
    elif rand_int == 68:
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "automotive service excellence":
            ...
            print("\nSorry! The correct answer was Automotive Service Excellence."); wrong += 1; questions += 1
    elif rand_int == 69:
        ...
        if ans.lower().strip() == "d" or ans.lower().strip() == "body control module":
            ...
            print("\nSorry! The correct answer was Body Control Module."); wrong += 1; questions += 1
    elif rand_int == 70:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "throttle position sensor":
            ...
            print("\nSorry! The correct answer was Throttle Position Sensor."); wrong += 1; questions += 1
    elif rand_int == 71:
        ...
        if ans.lower().strip() == "d" or ans.lower().strip() == "specialty equipment marketing association":
            ...
            print("\nSorry! The correct answer was Specialty Equipment Marketing Association."); wrong += 1; questions += 1
    elif rand_int == 72:
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "data link connector":
            ...
            print("\nSorry! The correct answer was Data Link Connector."); wrong += 1; questions += 1
    elif rand_int == 74:
        ...
        if ans.lower().strip() == "d" or ans.lower().strip() == "mass airflow":
            ...
            print("\nSorry! The correct answer was Mass Airflow."); wrong += 1; questions += 1
    elif rand_int == 75:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "digital volt-ohmmeter":
            ...
            print("\nSorry! The correct answer was Digital Volt-Ohmmeter."); wrong += 1; questions += 1
    elif rand_int == 76:
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "ground":
            ...
            print("\nSorry! The correct answer was Ground."); wrong += 1; questions += 1
    elif rand_int == 77:
        ...
        if ans.lower().strip() == "d" or ans.lower().strip() == "positive crankcase ventilation":
            ...
            print("\nSorry! The correct answer was Positive Crankcase Ventilation."); wrong += 1; questions += 1
#Questions 78 through 92 will have torque specifications. Please select the correct amount of torque.
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "25 ft/lbs and 50 ft/lbs":
            ...
            print("\nSorry! The correct answer was 25 ft/lbs and 50 ft/lbs."); wrong += 1; questions += 1
    elif rand_int == 79:
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "15 ft/lbs and 30 ft/lbs":
            ...
            print("\nSorry! The correct answer was 15 ft/lbs and 30 ft/lbs."); wrong += 1; questions += 1
    elif rand_int == 80:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "100 in/lbs":
            ...
            print("\nSorry! The correct answer was 100 in/lbs."); wrong += 1; questions += 1
    elif rand_int == 81:
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "50 ft/lbs":
            ...
            print("\nSorry! The correct answer was 50 ft/lbs."); wrong += 1; questions += 1
    elif rand_int == 82:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "hand tight":
            ...
            print("\nSorry! The correct answer was Hand Tight."); wrong += 1; questions += 1
    elif rand_int == 83:
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "25 ft/lbs":
            ...
            print("\nSorry! The correct answer was 25 ft/lbs."); wrong += 1; questions += 1
    elif rand_int == 86:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "15 ft/lbs":
            ...
            print("\nSorry! The correct answer was 15 ft/lbs."); wrong += 1; questions += 1
    elif rand_int == 87:
        ...
        if ans.lower().strip() == "d" or ans.lower().strip() == "50 in/lbs":
            ...
            print("\nSorry! The correct answer was 50 in/lbs."); wrong += 1; questions += 1
    elif rand_int == 89:
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "75 in/lbs":
            ...
            print("\nSorry! The correct answer was 75 in/lbs."); wrong += 1; questions += 1
    elif rand_int == 90:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "harmonic balancer adapter":
            ...
            print("\nSorry! The correct answer was Harmonic Balancer Adapter."); wrong += 1; questions += 1
    elif rand_int == 92:
...
# Questions 93 through 98 will be on pry bar requirements.
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "de-torque cam gear bolts":
            ...
            print("\nSorry! The correct answer was De-torque cam gear bolts."); wrong += 1; questions += 1
    elif rand_int == 94:
        print("During the assembly phase, when is NOT required to use a pry bar?\n a) Torque of rod nut\n b) Hand starting and snugging the oil pump nut\n c) Torque of cam gear bolts\n d) Torque of harmonic balancer\n")
        ans = input("What is your answer? ")
        if ans.lower().strip() == "a" or ans.lower().strip() == "torque of rod nuts":
            print("\nCorrect!"); correct += 1; questions += 1
        else:
            print("\nSorry! The correct answer was Torque of rod nuts."); wrong += 1; questions += 1
    elif rand_int == 95:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "de-torque/removal of oil pump":
            ...
            print("\nSorry! The correct answer was De-torque/removal of oil pump."); wrong += 1; questions += 1
    elif rand_int == 96:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "hand start/snugg of the oil pump nut":
            ...
            print("\nSorry! The correct answer was Hand start/Snugg of the oil pump nut."); wrong += 1; questions += 1
    elif rand_int == 97:
        ...
        if ans.lower().strip() == "d" or ans.lower().strip() == "torque of cam gear bolts":
            ...
            print("\nSorry! The correct answer was Torque of cam gear bolts."); wrong += 1; questions += 1
    elif rand_int == 98:
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "de-torque of the harmonic balancer bolt":
            ...
            print("\nSorry! The correct answer was De-Torque of the harmonic balancer bolt."); wrong += 1; questions += 1
    elif rand_int == 99:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "17":
            ...
            print("\nSorry! The correct answer was 17."); wrong += 1; questions += 1
    elif rand_int == 100:
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "10":
            ...
            print("\nSorry! The correct answer was 10."); wrong += 1; questions += 1
# Questions 102 through 137 will be on the 2023 Hot Rodders of Tomorrow Rulebook. Please answer correctly.
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "torque sticks":
            ...
            print("\nSorry! The correct answer was Torque Sticks."); wrong += 1; questions += 1
    elif rand_int == 103:
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "magnetic tray(s)":
            ...
            print("\nSorry! The correct answer was Magnetic Tray(s)."); wrong += 1; questions += 1
    elif rand_int == 106:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "valve covers":
            ...
            print("\nSorry! The correct answer was Valve Covers."); wrong += 1; questions += 1
    elif rand_int == 107:
        ...
        if ans.lower().strip() == "d" or ans.lower().strip() == "lifters":
            ...
            print("\nSorry! The correct answer was Lifters."); wrong += 1; questions += 1
    elif rand_int == 108:
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "intake valves":
            ...
            print("\nSorry! The correct answer was Intake Valves."); wrong += 1; questions += 1
    elif rand_int == 109:
        print("All engine components must be removed separately. Which component will remain on the Cylinder Head?\n a) Head Bolts\n b) Push Rods\n c) Spark Plugs\n d) Valve Springs\n")
        ans = input("What is your answer? ")
        if ans.lower().strip() == "d" or ans.lower().strip() == "valve springs":
            ...
            print("\nSorry! The correct answer was Valve Springs."); wrong += 1; questions += 1
    elif rand_int == 110:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "#1":
            ...
            print("\nSorry! The correct answer was #1."); wrong += 1; questions += 1
    elif rand_int == 111:
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "#7":
            ...
            print("\nSorry! The correct answer was #7."); wrong += 1; questions += 1
    elif rand_int == 112:
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "#3":
            ...
            print("\nSorry! The correct answer was #3."); wrong += 1; questions += 1
    elif rand_int == 113:
        print("With the number one piston at Top Dead Center (TDC) on Compression Stroke, which intake valve is adjusted?\n a) #3\n b) #5\n c) #6\n d) None of the Above\n")
        ans = input("What is your answer? ")
        if ans.lower().strip() == "b" or ans.lower().strip() == "#5":
            ...
            print("\nSorry! The correct answer was #5."); wrong += 1; questions += 1
    elif rand_int == 114:
        ...
        if ans.lower().strip() == "d" or ans.lower().strip() == "all of the above":
            ...
            print("\nSorry! The correct answer was All of the Above."); wrong += 1; questions += 1
    elif rand_int == 115:
        print("With the number one piston at Top Dead Center (TDC) on Exhaust Stroke, which exhaust valve is adjusted?\n a) #1\n b) #7\n c) #3\n d) #8\n")
        ans = input("What is your answer? ")
        if ans.lower().strip() == "b" or ans.lower().strip() == "#7":
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "oil pan nuts":
            ...
            print("\nSorry! The correct answer was Oil Pan Nuts."); wrong += 1; questions += 1
    elif rand_int == 117:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "rocker arm nuts":
            ...
            print("\nSorry! The correct answer was Rocker Arm Nuts."); wrong += 1; questions += 1
    elif rand_int == 118:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "applied twisting force to an object":
            ...
            print("\nSorry! The correct answer was Applied twisting force to an object."); wrong += 1; questions += 1
    elif rand_int == 119:
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "to make sure the fasteners gets the proper stretch":
            ...
            print("\nSorry! The correct answer was To make sure the fasteners gets the proper stretch."); wrong += 1; questions += 1
    elif rand_int == 120:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "to distrubute the gasket evenly to prvent gaps/wrinkles":
            ...
            print("\nSorry! The correct answer was To distribute the gasket evenly to prevent gaps/wrinkles."); wrong += 1; questions += 1
    elif rand_int == 121:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "oil pan gasket":
            ...
            print("\nSorry! The correct answer was Oil Pan Gasket."); wrong += 1; questions += 1
    elif rand_int == 122:
        ...
        if ans.lower().strip() == "d" or ans.lower().strip() == "carburetor gasket":
            ...
            print("\nSorry! The correct answer was Carburetor Gasket."); wrong += 1; questions += 1
    elif rand_int == 123:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "1 minute":
            ...
            print("\nSorry! The correct answer was 1 Minute."); wrong += 1; questions += 1
    elif rand_int == 126:
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "on the floor":
            ...
            print("\nSorry! The correct answer was On The Floor."); wrong += 1; questions += 1
    elif rand_int == 127:
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "180 degrees":
            ...
            print("\nSorry! The correct answer was 180 Degrees."); wrong += 1; questions += 1
    elif rand_int == 128:
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "protect cylinder walls and crank journals from being scratched":
            ...
            print("\nSorry! The correct answer was Protect cylinder walls and crank journals from being scratched."); wrong += 1; questions += 1
    elif rand_int == 129:
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "to keep oil from bypassing into the combustion chamber easily":
            ...
            print("\nSorry! The correct answer was To keep oil from bypassing into the combustion chamber easily."); wrong += 1; questions += 1
    elif rand_int == 130:
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "helmets are worn to protect your head from injury. safety glasses are worn to protect your eyes from injury":
            ...
            print("\nSorry! The correct answer was Helmets are worn to protect your head from injury. Safety glasses are worn to protect your eyes from injury."); wrong += 1; questions += 1
    elif rand_int == 131:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "on an engine that the balancer is not honed, you would have to turn at least 5 full turns to remove the balancer from the crankshaft":
            ...
            print("\nSorry! The correct answer was On an engine that the balancer is not honed, you would have to turn at least 5 full turns to remove the balancer from the crankshaft."); wrong += 1; questions += 1
    elif rand_int == 133:
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "the camshaft and the crankshaft will have the correct timing":
            ...
            print("\nSorry! The correct answer was The camshaft and the crankshaft will have the correct timing."); wrong += 1; questions += 1
    elif rand_int == 134:
        ...
        if ans.lower().strip() == "d" or ans.lower().strip() == "floor":
            ...
            print("\nSorry! The correct answer was Floor."); wrong += 1; questions += 1
    elif rand_int == 135:
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "100 yards":
            ...
            print("\nSorry! The correct answer was 100 yards."); wrong += 1; questions += 1
    elif rand_int == 136:
        print("Torque wrenches may NOT be placed on the following area(s):\n a) Padded Tray\n b) On The Floor\n c) On The Bench\n d) None of the Above\n")
        ans = input("What is your answer? ")
        if ans.lower().strip() == "b" or ans.lower().strip() == "on the floor":
        ...
        if ans.lower().strip() == "d" or ans.lower().strip() == "6":
            ...
            print("\nSorry! The correct answer was 6."); wrong += 1; questions += 1
    elif rand_int == 138:
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "circuit breaker":
            ...
            print("\nSorry! The correct answer was Circuit Breaker."); wrong += 1; questions += 1
    elif rand_int == 139:
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "fusible link":
            ...
            print("\nSorry! The correct answer was Fusible Link."); wrong += 1; questions += 1
    elif rand_int == 140:
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "insulator":
            ...
            print("\nSorry! The correct answer was Insulator."); wrong += 1; questions += 1
    elif rand_int == 141:
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "electricity":
            ...
            print("\nSorry! The correct answer was Electricity."); wrong += 1; questions += 1
    elif rand_int == 142:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "current":
            ...
            print("\nSorry! The correct answer was Current."); wrong += 1; questions += 1
    elif rand_int == 143:
        ...
        if ans.lower().strip() == "d" or ans.lower().strip() == "voltage":
            ...
            print("\nSorry! The correct answer was Voltage."); wrong += 1; questions += 1
    elif rand_int == 144:
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "fuse":
            ...
            print("\nSorry! The correct answer was Fuse."); wrong += 1; questions += 1
# Use Ohm's Law for Questions 145 through 148. Please answer correctly.
        ...
        if ans.lower().strip() == "d" or ans.lower().strip() == "6 amps":
            ...
            print("\nSorry! The correct answer was 6 amps."); wrong += 1; questions += 1
    elif rand_int == 146:
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "6 ohms":
            ...
            print("\nSorry! The correct answer was 6 ohms."); wrong += 1; questions += 1
    elif rand_int == 147:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "6 volts":
            ...
            print("\nSorry! The correct answer was 6 volts."); wrong += 1; questions += 1
    elif rand_int == 148:
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "72 volts":
            ...
            print("\nSorry! The correct answer was 72 volts."); wrong += 1; questions += 1
    elif rand_int == 149:
        ...
        if ans.lower().strip() == "d" or ans.lower().strip() == "36 watts":
            ...
            print("\nSorry! The correct answer was 36 watts."); wrong += 1; questions += 1
    elif rand_int == 150:
        ...
        if ans.lower().strip() == "d" or ans.lower().strip() == "12 watts":
            ...
            print("\nSorry! The correct answer was 12 watts."); wrong += 1; questions += 1
    elif rand_int == 151:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "33 watts":
            ...
            print("\nSorry! The correct answer was 33 watts."); wrong += 1; questions += 1
# Questions 152 through 172 will be on General Automotive. Please answer correctly.
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "blueprinting":
            ...
            print("\nSorry! The correct answer was Blueprinting."); wrong += 1; questions += 1
    elif rand_int == 153:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "to make crankshaft parallel to camshaft":
            ...
            print("\nSorry! The correct answer was To make crankshaft parallel to camshaft."); wrong += 1; questions += 1
    elif rand_int == 154:
        ...
        if ans.lower().strip() == "d" or ans.lower().strip() == "hone":
            ...
            print("\nSorry! The correct answer was Hone."); wrong += 1; questions += 1
    elif rand_int == 155:
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "dial-bore gauge":
            ...
            print("\nSorry! The correct answer was Dial-Bore Gauge."); wrong += 1; questions += 1
    elif rand_int == 157:
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "modeling clay":
            ...
            print("\nSorry! The correct answer was Modeling clay."); wrong += 1; questions += 1
    elif rand_int == 158:
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "micrometer":
            ...
            print("\nSorry! The correct answer was Micrometer."); wrong += 1; questions += 1
    elif rand_int == 159:
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "1-3-4-2":
            ...
            print("\nSorry! The correct answer was 1-3-4-2."); wrong += 1; questions += 1
    elif rand_int == 160:
        ...
        if ans.lower().strip() == "d" or ans.lower().strip() == "firing order":
            ...
            print("\nSorry! The correct answer was Firing order."); wrong += 1; questions += 1
    elif rand_int == 161:
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "10:1":
            ...
            print("\nSorry! The correct answer was 10:1."); wrong += 1; questions += 1
    elif rand_int == 162:
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "distribute air and fuel equally to the cylinders":
            ...
            print("\nSorry! The correct answer was Distribute air and fuel equally to the cylinders."); wrong += 1; questions += 1
    elif rand_int == 163:
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "coolant leaking into the combustion chamber":
            ...
            print("\nSorry! The correct answer was Coolant leaking into the combustion chamber."); wrong += 1; questions += 1
    elif rand_int == 164:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "3,000 miles":
            ...
            print("\nSorry! The correct answer was 3,000 Miles."); wrong += 1; questions += 1
    elif rand_int == 165:
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "winter":
            ...
            print("\nSorry! The correct answer was Winter."); wrong += 1; questions += 1
    elif rand_int == 166:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "uneven tire wear":
            ...
            print("\nSorry! The correct answer was Uneven tire wear."); wrong += 1; questions += 1
    elif rand_int == 167:
        ...
        if ans.lower().strip() == "a" or ans.lower().strip() == "dot 4 fluid has a higher boiling point than dot 3 fluid":
            ...
            print("\nSorry! The correct answer was DOT 4 fluid has a higher boiling point than DOT 3 fluid."); wrong += 1; questions += 1
    elif rand_int == 168:
        ...
        if ans.lower().strip() == "d" or ans.lower().strip() == "the study of the effects of air resistance and lift on vehicles":
            ...
            print("\nSorry! The correct answer was The study of the effects of air resistance and lift on vehicles."); wrong += 1; questions += 1
    elif rand_int == 170:
        ...
        if ans.lower().strip() == "b" or ans.lower().strip() == "the volume displaced on intake strokes during each crankshaft revolution":
            ...
            print("\nSorry! The correct answer was The volume displaced on intake strokes during each crankshaft revolution."); wrong += 1; questions += 1
    elif rand_int == 171:
        ...
        if ans.lower().strip() == "d" or ans.lower().strip() == "neither technician a nor b":
            ...
            print("\nSorry! The correct answer was Neither Technician A nor B."); wrong += 1; questions += 1
    elif rand_int == 172:
        ...
        if ans.lower().strip() == "c" or ans.lower().strip() == "both technician a and b":
            ...
            print("\nSorry! The correct answer was Both Technician A and B."); wrong += 1; questions += 1
# After this, to 236, the questions should use pictures to help you identify tools and items. I don't know how to add pictures in.
        ...
        print("I can't really put the identification section in this, but you will study it right? (Yes or No, Y/N)\n It is questions 173 to 236.")
        ans = input("What is your answer? ")
        if ans.lower().strip() == "yes" or ans.lower().strip() == "y":
            print("\nCorrect! I'll believe you on this one."); correct += 1; questions += 1
        else:
            print("\nSorry! The correct answer was Yes."); wrong += 1; questions += 1
    else:
        print("Sorry, your number has not been programmed yet. How did you get here? The program shouldn't let you get here.")
    def track_score():
        score_lock = "Y"
        while score_lock == "Y":
            print(f"\nGood job! You have worked on {questions} questions this session!")
            show_score = input("\nWould you like to see your current score? Y/N ")
            if show_score.lower().strip() == "y" or show_score.lower().strip() == "yes":
                print(f"You have {wrong} questions wrong and {correct} questions right.\nThis causes you to have a score of {(correct / questions) * 100}%.")
                score_lock = "X"
                continue
    ...
    if questions == 10 or questions == 20 or questions == 30 or questions == 40 or questions == 50 or questions == 60 or questions == 70 or questions == 80 or questions == 90 or questions == 100 or questions == 110 or questions == 120 or questions == 130 or questions == 140 or questions == 150 or questions == 160 or questions == 170 or questions == 180 or questions == 190:
        track_score()
    elif questions == 200:
